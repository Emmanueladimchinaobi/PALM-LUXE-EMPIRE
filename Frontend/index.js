...
if (copyButton) {
    copyButton.addEventListener("click", () => {
        navigator.clipboard.writeText("https://palm-luxe-empire.vercel.app/");
        alert("link copied!");
    });
}
...
if (copyButton2) {
    copyButton2.addEventListener("click", () => {
        navigator.clipboard.writeText("https://www.tiktok.com/@realpamluxe_empire_");
        alert("link copied!");
    });
}
...
if (copyButton3) {
    copyButton3.addEventListener("click", () => {
        navigator.clipboard.writeText("https://www.instagram.com/pam_luxe_empire_/");
        alert("link copied!");
    });
}
...
if (copyButton4) {
    copyButton4.addEventListener("click", () => {
        navigator.clipboard.writeText("https://wa.me/2349030735969?text=Hello,Welcome to Palm Luxe Empire 🌷");
        alert("link copied!");
    });
}